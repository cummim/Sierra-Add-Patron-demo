# Filename:	demo.py
# Description:	Add a patron to a Sierra database
# Credit:	Original template by Milton Howard, Innovative Interfaces
...
# 
# Copyright:    To the extent possible under law, the author(s) have dedicated all copyright
# and related and neighboring rights to this software to the public domain worldwide.
# This software is distributed without any warranty. 
#
# Usage:
# 1. Replace the placeholder text below for SIERRA_API_KEY and SIERRA_API_KEY_SECRET
# 2. Replace the value of SIERRA_API_HOST with the URL of the desired Sierra server
# 3. Replace the values for the pcodes and ptype appropriate for your library
